...
>
  ...
  <div className="relative px-4 xs:px-2 pt-6 xs:pt-4">
    <div className="rounded-xl w-full px-4 xs:px-2 py-3 xs:py-2 text-center text-black">
      ...
      <p className="text-black text-lg xs:text-sm sm:text-xl">Sky blue Colour</p>
      <p className="text-black text-lg xs:text-sm sm:text-xl">Sky high performance with M4</p>
